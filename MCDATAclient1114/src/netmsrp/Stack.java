...
public class Stack implements Observer {
	...
	synchronized protected static Connections getConnectionsInstance(InetAddress address)
	{
		...
		System.out.println("[stack]getConnectionsInstance");
		if (toReturn == null) {
			System.out.println("[stacknull]");
	...
	synchronized protected static Connections getConnectionsInstance(InetAddress address, int port)
	{
		Connections toReturn = addressConnections.get(address);
		System.out.println("[stack]");
		if (toReturn == null) {
			System.out.println("[stack]null");
	        toReturn = new Connections(address, port);
	        addressConnections.put(address, toReturn);
	        System.out.println("[stack]address,toreturn"+address+","+toReturn);
		}
		return toReturn;
	}
