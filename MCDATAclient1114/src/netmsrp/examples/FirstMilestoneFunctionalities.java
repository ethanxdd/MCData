...
public class FirstMilestoneFunctionalities
{
        ...
        implements SessionListener
    {
         ...
         * (non-Javadoc)
         * 
         * @see netmsrp.SessionListener#acceptHook(netmsrp.Session,
         * netmsrp.IncomingMessage)
         */
        /*
         ...
         * (non-Javadoc)
         * 
         * @see netmsrp.SessionListener#receiveMessage(netmsrp.Session,
         * netmsrp.Message)
         */
        /*
         ...
         * (non-Javadoc)
         * 
         * @see netmsrp.SessionListener#receivedReport(netmsrp.Session,
         * netmsrp.Transaction)
         */
        /*
		...
		public void receivedReport(Session session, Transaction report)
        {
            ...
            report.getByteRange();
            // see netmsrp.Transaction.byteRange field javadoc's comments for more
            // info
         ...
         * (non-Javadoc)
         * 
         * @see netmsrp.SessionListener#updateSendStatus(netmsrp.Session,
         * netmsrp.Message, long)
         */
        /*
