    ...
    extends Message
{
     ...
     * 
     * @see SessionListener#abortedMessageEvent(netmsrp.events.MessageAbortedEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.Message#getMessageID()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.Message#isComplete()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.Message#getDirection()
     */
    @Override
