...
import netmsrp.exceptions.NotEnoughDataException;
import netmsrp.exceptions.NotEnoughStorageException;
    ...
    extends DataContainer
{
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#size()
     */
    @Override
    public long size()
    {
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#currentReadOffset()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#hasDataToRead()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#put(long, byte[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#put(byte)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#get(long, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#get(byte[], int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#rewindRead(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see netmsrp.DataContainer#dispose()
     */
    @Override
    public void dispose()
    {
